...
res_name = ['compare_noise_factor_' num2str(noise_factors(1)) '_',...
...
%     t0 = tic;
%     [R1] = example2_2(0,noise_factors,dt);
%     t1 = toc(t0);
%     Results1{i} = R1;
%     time_1(i) = t1;
%     diary off
...
%     t0 = tic;
%     [R2] = example2_2b(0,noise_factors,dt);
%     t2 = toc(t0);
%     Results2{i} = R2;
%     time_2(i) = t2;
%     diary off
...
for i=1:n
    ...
    for j=1:length(noise_factors)
        ...
        axis tight; yl = get(gca, 'ylim'); ylim([yl(1)-0.1*norm(yl),yl(2)+0.1*norm(yl)]); xlim([0.5,n+0.5]);
        t1_iter(i,j) = R1ij.stats.iter_count;
        ...
        axis tight; yl = get(gca, 'ylim'); ylim([yl(1)-0.1*norm(yl),yl(2)+0.1*norm(yl)]); xlim([0.5,n+0.5]);
        t1_f(i,j) = R1ij.stats.n_call_nlp_f;
        ...
        axis tight; yl = get(gca, 'ylim'); ylim([yl(1)-0.1*norm(yl),yl(2)+0.1*norm(yl)]); xlim([0.5,n+0.5]);
        t1_gf(i,j) = R1ij.stats.n_call_nlp_grad_f;
        ...
        axis tight; yl = get(gca, 'ylim'); ylim([yl(1)-0.1*norm(yl),yl(2)+0.1*norm(yl)]); xlim([0.5,n+0.5]);
        t1_obj(i,j) = R1ij.stats.iterations.obj(end);
    ...
    subplot(nv,nh,2)
    plot(i+0.2,t1_tot_i,'o','Color',cs1(end,:),'MarkerFaceColor',cs1(end,:))
    hold on
...
for j=1:length(noise_factors)
    subplot(2,4,1)
    plot(noise_factors(j),mean(t1_tot(:,j)),'o','Color',cs1(j,:),'MarkerFaceColor',cs1(j,:))
    hold on
    ...
    subplot(2,4,2)
    plot(noise_factors(j),mean(t1_feval(:,j)),'o','Color',cs1(j,:),'MarkerFaceColor',cs1(j,:))
    hold on
    ...
    subplot(2,4,3)
    plot(noise_factors(j),mean(t1_tot(:,j)-t1_feval(:,j)),'o','Color',cs1(j,:),'MarkerFaceColor',cs1(j,:))
    hold on
    ...
    subplot(2,4,4)
    plot(noise_factors(j),mean(t1_feval(:,j)./t1_tot(:,j)*100),'o','Color',cs1(j,:),'MarkerFaceColor',cs1(j,:))
    hold on
    ...
    subplot(2,4,5)
    plot(noise_factors(j),mean(t1_iter(:,j)),'o','Color',cs1(j,:),'MarkerFaceColor',cs1(j,:))
    hold on
    ...
    subplot(2,4,6)
    plot(noise_factors(j),mean(t1_f(:,j)),'o','Color',cs1(j,:),'MarkerFaceColor',cs1(j,:))
    hold on
    ...
    subplot(2,4,7)
    plot(noise_factors(j),mean(t1_gf(:,j)),'o','Color',cs1(j,:),'MarkerFaceColor',cs1(j,:))
    hold on
    ...
    subplot(2,4,8)
    plot(noise_factors(j),mean(t1_obj(:,j)),'o','Color',cs1(j,:),'MarkerFaceColor',cs1(j,:))
    hold on
